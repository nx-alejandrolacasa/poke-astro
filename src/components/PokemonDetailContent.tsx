      ...
      try {
        ...
        const typesPromises = pokemon.types.map(async ({ type }) => {
          ...
          const translation = data.names.find(
            (n: { language: { name: string }; name: string }) => n.language.name === locale
          )
          return {
            name: type.name,
          ...
          .then((data) => {
            ...
            const entries =
              data.flavor_text_entries?.filter(
                (entry: { language: { name: string } }) => entry.language.name === locale
              ) ||
              data.flavor_text_entries?.filter(
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-[200px_1fr] md:gap-4 lg:grid-cols-[240px_1fr] lg:gap-6">
        ...
        <div className="flex flex-col items-center justify-start">
          ...
          >
            ...
            />
            <span className="absolute top-1 right-1 rounded-full bg-gray-900/80 px-2 py-0.5 font-bold font-mono text-white text-xs backdrop-blur-sm md:text-sm dark:bg-white/80 dark:text-gray-900">
          ...
          <h1 className="mt-2 text-center font-extrabold text-gray-900 text-xl capitalize tracking-tight md:hidden dark:text-gray-100">
        ...
        <div className="space-y-2 md:space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 md:grid-cols-4 md:gap-3">
            ...
            <div className="rounded-lg border border-gray-300 bg-gray-50 p-2 transition-colors dark:border-gray-700 dark:bg-gray-800/50">
              ...
              <p className="font-semibold text-base text-gray-900 md:text-lg dark:text-gray-100">
        ...
        statsSection={
          <div className="rounded-lg border border-gray-300 bg-gray-50 p-3 transition-colors dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <div className="space-y-1.5">
              ...
              <div className="mt-2 grid grid-cols-[90px_40px_1fr] gap-2 border-gray-400 border-t pt-2 dark:border-gray-700">
                <div className="text-right font-bold text-gray-900 text-sm dark:text-gray-100">
                  {t.pokemon.total}
                </div>
                <div className="text-right font-bold text-gray-900 text-sm dark:text-gray-100">
                  {totalStats}
