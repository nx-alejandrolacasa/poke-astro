  ...
  return (
    <div className="space-y-8 pb-8 md:space-y-12 md:pb-12">
      ...
      <section className="space-y-4 pt-4 text-center md:pt-6">
        <h1 className="font-display font-bold text-3xl uppercase tracking-wider text-gray-900 md:text-5xl dark:text-neon-blue">
          {t.home.title}
        </h1>
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 md:gap-3">
          <div className="hud-corners rounded-sm border border-gray-200 bg-white p-3 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-[1.02] md:p-4 dark:border-dex-border dark:bg-dex-surface">
            <div className="space-y-0.5">
              ...
              <p className="font-mono font-black text-2xl text-gray-900 md:text-3xl dark:text-neon-blue">{totalPokemon.toLocaleString(locale)}</p>
          ...
          <div className="hud-corners rounded-sm border border-gray-200 bg-white p-3 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-[1.02] md:p-4 dark:border-dex-border dark:bg-dex-surface">
            <div className="space-y-0.5">
              <p className="font-display text-[9px] font-bold uppercase tracking-widest text-gray-500 md:text-[10px] dark:text-neon-blue/60">{t.home.generations}</p>
              <p className="font-mono font-black text-2xl text-gray-900 md:text-3xl dark:text-neon-blue">{generations.length}</p>
            ...
            {generations.map((gen, index) => (
              <a key={index} href={`/${locale}/generation/${index + 1}`} className="group rounded-sm border border-gray-200 bg-white p-3 shadow-sm transition-all duration-200 active:scale-95 md:p-4 dark:border-dex-border dark:bg-dex-surface">
                <div className="space-y-0.5 text-center">
                  <p className="font-mono font-bold text-gray-700 text-sm transition-colors group-hover:text-primary-600 md:text-base dark:text-gray-300 dark:group-hover:text-neon-blue">Gen {index + 1}</p>
