  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center gap-3">
        ...
        <span className="font-display text-[10px] uppercase tracking-widest text-gray-400 dark:text-primary/50">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-3">
          <h3 className="font-display text-[10px] font-bold uppercase tracking-widest text-gray-700 dark:text-neon-cyan/70">
            {locale === 'es' ? 'Atacando' : 'Attacking'}
          </h3>
          <div className="space-y-2">
            <MatchupGroup
              label={locale === 'es' ? 'Super eficaz' : 'Super effective'}
              labelColor="text-emerald-600 dark:text-neon-green"
              icon="2\u00D7"
              iconBg="bg-emerald-500 dark:bg-neon-green"
              iconText="text-white dark:text-dex-bg"
            ...
            <MatchupGroup
              ...
              labelColor="text-orange-600 dark:text-neon-amber"
              icon="\u00BD"
              iconBg="bg-orange-400 dark:bg-neon-amber"
              iconText="text-white dark:text-dex-bg"
            ...
            <MatchupGroup
              ...
              iconText="text-white dark:text-neon-red"
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <MatchupGroup
              ...
              labelColor="text-red-600 dark:text-neon-red"
              icon="2\u00D7"
              iconBg="bg-red-500 dark:bg-neon-red"
              iconText="text-white dark:text-dex-bg"
            ...
            <MatchupGroup
              ...
              labelColor="text-teal-600 dark:text-neon-green"
              icon="\u00BD"
              iconBg="bg-teal-500 dark:bg-neon-green"
              iconText="text-white dark:text-dex-bg"
            ...
            <MatchupGroup
              ...
              labelColor="text-primary-600 dark:text-neon-cyan"
              icon="0"
              iconBg="bg-primary dark:bg-neon-cyan"
              iconText="text-white dark:text-dex-bg"
  ...
  return (
    <div>
      <div className="mb-1 flex items-center gap-1.5">
        <span
          className={`inline-flex h-5 w-5 items-center justify-center rounded-sm font-mono text-[10px] font-bold ${iconBg} ${iconText}`}
        >
          {icon}
        </span>
